    ...
    return (
      <div
        className={classnames(
          "sci-react-ui-base-example-page-base",
      ...
      >
        <div className="title">
          ...
          <code className="code">
            npm install --save {this.props.npmPackageName} --save-prefix "~"
          </code>
        </div>
        ...
        <div className="examples">
          ...
          <p>
            ...
            <a href={this.props.exampleSrcUrl} target="_blank">
              here
            </a>
          </p>
          {this.props.examples.map((value, index) => {
            return <ExampleComponentBase key={index} {...value} />;
          })}
        </div>
        <div className="links-section">
          ...
          <ul className="list">
            ...
            <li>
              <a href={this.props.npmUrl} target="_blank">
                npm
              </a>
            </li>
          </ul>
